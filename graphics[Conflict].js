...
function display(_game, bot_advice){
	...
	main.font=Math.round(18*ratio())+"px Georgia";
	...
	for (var i=0; i<_game.displayed_choices.length; i++){
		draw_button(main, _game.displayed_choices[i].text, "#ffffff", _game.displayed_choices[i].X, _game.displayed_choices[i].Y);
...
function draw_button(_canvas, _text, _color, _X, _Y){
